...
const dates1 = [1757563461759, 1787563493626, 1797563538701]
...
describe('Contracts', () => {
  ...
  describe('Apartment Mgt', () => {
    ...
    it('Should confirm apartment update', async () => {
      ...
      await contract
        .connect(owner)
        .updateApartment(id, newName, description, location, images.join(','), rooms, toWei(newPrice))
  ...
  describe('Booking Management', () => {
    ...
    describe('Failures', () =>{
      ...
      it('Should prevent booking apartment with wrong id', async () => {
        const amount = price * dates1.length + (price * dates1.length * securityFee) / 100
        await expect(
